...
// Make CRM_RemoteExpense_ExtensionUtil available.
require_once __DIR__ . '/../../remote_expense.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('remote_expense');
 ...
 */
function _remote_expense_test_civicrm_container(ContainerBuilder $container): void {
}
